...
from PyQt5.QtWidgets import QWidget, QLabel, QFileDialog, QPushButton, QDialog,QFontDialog,QStyle,\
    QPlainTextEdit,QMessageBox,QApplication,QRadioButton,QHBoxLayout,QGroupBox
import sys
import vypocet
...
class Hlavni(qtw.QMainWindow):
    ...
    def vypocet(self):
        self.vysledek = vypocet.Optimalizace(self.char_sondy,self.namerene).vysledek
        ...
        self.plotni_to()
        QMessageBox.information(self, "Default",f"kLa je: {round(self.kla,5)}")
    def plotni_to(self):
